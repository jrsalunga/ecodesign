					...
					init:function(){
						...
						_.navigs&&_.navigs.data('navigs')
							&&_.navigs.navigs(function(n,__){
								$('.pagin >ul >li').eq(currPic-1).find(".zoomSp1").fadeTo(500, 0)
								currPic=n+1;
								$('.pagin >ul >li').eq(n).find(".zoomSp1").fadeTo(500, 1)
								total_items=$(".pagin li").length;
								$('.txt_nums').text(currPic +"/" + total_items);
