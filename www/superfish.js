...
;(function($){
	...
	$.fn.extend({
		hideSuperfishUl : function(){
            ...
            selectLi.not('.active').find('>a').css({color:'#636363','backgroundPosition':'right 50px'});
		   	selectLi.not('.active').find('> span').stop().animate({opacity:0}, aniButtonDuration, 'easeOutCubic', function(){
